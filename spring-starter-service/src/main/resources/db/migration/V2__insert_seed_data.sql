...
INSERT INTO tasks (id, project_id, assignee_id, title, description, status, due_date, created_at, updated_at)
VALUES (1, 1, 1, 'Design Figma Mockups', 'testdescription', 'DONE', CURRENT_TIMESTAMP - INTERVAL '1 DAY',
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (2, 1, 1, 'Implement Frontend Component', 'testdescription', 'IN_PROGRESS',
...
INSERT INTO tasks (id, project_id, assignee_id, title, description, status, due_date, created_at, updated_at)
VALUES (3, 2, 1, 'Setup React Native Environment', 'testdescription', 'TODO', CURRENT_TIMESTAMP + INTERVAL '7 DAYS',
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       (4, 2, 1, 'Configure Firebase Auth', 'testdescription', 'TODO', CURRENT_TIMESTAMP + INTERVAL '10 DAYS',
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
